...
const MobileHeading = () => {
  return (
    <div className="mobile-heading bg-[#3F1324] flex w-full flex-col items-center justify-center text-center">
      ...
      >
        <h1 className="flex flex-wrap font-Xirod pantherhacks-title text-5xl sm:text-6xl text-[#befcfd] w-full px-4 sm:px-16 drop-shadow-lg">
      ...
      <div className="flex flex-col w-full justify-center items-center text-center z-10 gap-y-8 pt-5 pb-10 secondary-title">
        <h2 className="font-Xirod text-3xl text-white cursor-default">{hackathonDateInfo.dateString}</h2>
      </div>
    </div>
  );
};
