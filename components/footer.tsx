...
const Footer = () => {
  return (
    <footer className="flex flex-col justify-center items-center w-full space-y-2 p-4 bg-primary">
      ...
      <div className="flex flex-row space-x-1" aria-label="Social Links">
        <Link href="https://github.com/pantherhacks" target="_blank" aria-label="PantherHacks GitHub">
          <Button size="icon">
            <Image src="./icons/github.svg" alt="GitHub Icon" width={24} height={24} className="filter invert" />
          </Button>
        </Link>
        <Link href="https://discord.gg/9NSwX5PxqC" target="_blank" aria-label="PantherHacks Discord">
          <Button size="icon">
            <Image src="./icons/discord.svg" alt="Discord Icon" width={24} height={24} className="filter invert" />
          </Button>
        </Link>
        <Link href="https://www.instagram.com/chapmancsclub/" target="_blank" aria-label="PantherHacks Instagram">
          <Button size="icon">
